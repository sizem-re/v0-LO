  ...
  return (
    <div>
      <div className="mb-12">
        ...
        <p className="text-lg max-w-2xl mb-6">{mockList.description}</p>
        <div className="flex items-center justify-between">
          <p className="text-sm text-black/60">{mockList.timestamp}</p>

          {isAuthenticated && (
            <ShareToFarcaster listId={params.id} listTitle={mockList.title} listDescription={mockList.description} />
          )}
        </div>
      </div>
