...
export default function VanillaMap({ places, height = "500px", onPlaceSelect, className = "" }: VanillaMapProps) {
        ...
        const marker = window.L.marker([place.coordinates.lat, place.coordinates.lng])
          ...
          .bindPopup(`
            <div class="p-1">
              ...
              <button class="text-xs underline block mt-2 view-details" data-id="${place.id}">View details</button>
            </div>
          `)
